...
public record BookUpdateDTO(@NotEmpty(message = "Book's isbn must be specified")
                            ...
                            @PositiveOrZero(message = "Book's available quantity must be a positive number") int availableQuantity,
